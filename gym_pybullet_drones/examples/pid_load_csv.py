...
def run(
    ...
    # data = pd.read_csv("/home/kangle/Documents/FYP/oldDrone/src/Demonstrations/2024_05_22_Flight_Data/processed/rosbag2_2024_05_22-17_26_15.csv")
    # data['drone_x'] = data['drone_x'] / 1000.00
    # data['drone_y'] = data['drone_y'] / 1000.00
    # data['drone_z'] = data['drone_z'] / 1000.00

    # trajectory_points = data[['drone_x', 'drone_y', 'drone_z']].values
    # print(trajectory_points)
    #### Initialize the ascent trajectory ######################
    PERIOD = 6
    NUM_WP = control_freq_hz * PERIOD #48*6
